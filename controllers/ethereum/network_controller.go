...
func (r *NetworkReconciler) reconcileNodeConfigmap(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network, bootnodes []string) error {
...
func (r *NetworkReconciler) specNodeDataPVC(pvc *corev1.PersistentVolumeClaim, node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) {
...
func (r *NetworkReconciler) reconcileNodeDataPVC(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) error {
...
func (r *NetworkReconciler) createNodeVolumes(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) []corev1.Volume {
...
func (r *NetworkReconciler) createNodeVolumeMounts(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) []corev1.VolumeMount {
...
func (r *NetworkReconciler) specNodeStatefulSet(sts *appsv1.StatefulSet, node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network, args []string, volumes []corev1.Volume, volumeMounts []corev1.VolumeMount, affinity *corev1.Affinity) {
...
func (r *NetworkReconciler) reconcileNodeStatefulSet(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network, bootnodes []string) error {
...
func (r *NetworkReconciler) specNodeSecret(secret *corev1.Secret, node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) error {
...
func (r *NetworkReconciler) reconcileNodeSecret(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) (publicKey string, err error) {
...
func (r *NetworkReconciler) specNodeService(svc *corev1.Service, node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) {
	labels := node.Labels(network.Name)
	client := node.Client
...
func (r *NetworkReconciler) reconcileNodeService(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network) (ip string, err error) {
...
func (r *NetworkReconciler) reconcileNode(node *ethereumv1alpha1.NodeSpec, network *ethereumv1alpha1.Network, bootnodes []string) (enodeURL string, err error) {
