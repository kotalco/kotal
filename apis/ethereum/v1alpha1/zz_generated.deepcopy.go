...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *XNode) DeepCopyInto(out *XNode) {
	*out = *in
	if in.Import != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new XNode.
func (in *XNode) DeepCopy() *XNode {
	if in == nil {
		return nil
	}
	out := new(XNode)
